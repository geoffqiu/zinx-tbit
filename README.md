...
## zinx源码地址
### Github
Git: https://github.com/geoffqiu/zinx-tbit
...
```bash
# 克隆项目
$ git clone https://github.com/geoffqiu/zinx-tbit.git
...
import (
	"fmt"
	"github.com/geoffqiu/zinx-tbit/ziface"
	"github.com/geoffqiu/zinx-tbit/znet"
)
...
---
[zinx(websocket版本)](https://github.com/geoffqiu/zinx-tbit/tree/wsserver)
#### 开发者
-  胡贵建([@huguijian](https://github.com/huguijian))
...
<a href="https://github.com/geoffqiu/zinx-tbit/graphs/contributors">
